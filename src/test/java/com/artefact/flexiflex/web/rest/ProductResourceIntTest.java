package com.artefact.flexiflex.web.rest;

import com.artefact.flexiflex.FlexiflexApp;

import com.artefact.flexiflex.domain.Product;
import com.artefact.flexiflex.repository.ProductRepository;
import com.artefact.flexiflex.repository.search.ProductSearchRepository;
import com.artefact.flexiflex.web.rest.errors.ExceptionTranslator;
...
import static com.artefact.flexiflex.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = FlexiflexApp.class)
public class ProductResourceIntTest {

    private static final String DEFAULT_URLS = "AAAAAAAAAA";
    private static final String UPDATED_URLS = "BBBBBBBBBB";
    ...
    /**
     * This repository is mocked in the com.artefact.flexiflex.repository.search test package.
     *
     * @see com.artefact.flexiflex.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getUrls()).isEqualTo(DEFAULT_URLS);
        assertThat(testProduct.getTitle()).isEqualTo(DEFAULT_TITLE);
        assertThat(testProduct.getSynopsis()).isEqualTo(DEFAULT_SYNOPSIS);
        assertThat(testProduct.getTmdbId()).isEqualTo(DEFAULT_TMDB_ID);
    ...
    public void updateProduct() throws Exception {
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getUrls()).isEqualTo(UPDATED_URLS);
        assertThat(testProduct.getTitle()).isEqualTo(UPDATED_TITLE);
        assertThat(testProduct.getSynopsis()).isEqualTo(UPDATED_SYNOPSIS);
        assertThat(testProduct.getTmdbId()).isEqualTo(UPDATED_TMDB_ID);
